const FreeCard = () => {
  return (
    <div className="relative mt-14 flex w-[256px] justify-center rounded-[20px] bg-brand-900r from-[#868CFF] via-[#432CF3] to-lime-500 pb-4">
      <div className="absolute -top-12 flex h-24 w-24 items-center justify-center rounded-full border-[4px] border-white bg-brand-900 from-[#868CFF] to-lime-500 dark:!border-navy-800">
        <svg
          width="41"
          height="41"
          viewBox="0 0 41 41"
      ...
      <div className="mt-16 flex h-fit flex-col items-center">
        ...
        <a
          target="blank"
          className="text-medium mt-7 block rounded-full bg-brand-900 from-white/50 to-white/10 py-[12px] px-11 text-center text-base text-white hover:bg-brand-900 hover:from-white/40 hover:to-white/5 "
