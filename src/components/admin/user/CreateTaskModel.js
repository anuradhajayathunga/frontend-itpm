...
const CreateTaskModal = ({
  ...
  const wasteTypeIcons = {
    Plastic: <FiTrash2 className="text-green-500" />,
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div className="bg-gray-50 rounded-lg p-4 border border-gray-100">
            <div className="space-y-1">
              <label className="text-sm font-medium text-gray-700 flex items-center">
                <MdTitle className="mr-1 text-green-500" /> Title
              </label>
              <input
                type="text"
                name="title"
                ...
                onChange={onChange}
                className="w-full border border-gray-200 rounded-lg px-3 py-2 bg-gray-100 text-gray-700 focus:ring-2 focus:ring-green-500 focus:outline-none"
                required
              />
            </div>
            <div className="space-y-1">
              <label className="text-sm font-medium text-gray-700 flex items-center mt-3">
                <MdOutlineDescription className="mr-1 text-green-500" />{" "}
                Description
              </label>
              <textarea
                name="description"
          ...
          <div className="bg-gray-50 rounded-lg p-4 border border-gray-100">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-1">
                <label className="text-sm font-medium text-gray-700 flex items-center">
                  <FiMapPin className="mr-1 text-green-500" /> City
                </label>
                <input
                  type="text"
                  name="city"
              ...
              <div className="space-y-1">
                <label className="text-sm font-medium text-gray-700 flex items-center">
                  <FiMapPin className="mr-1 text-green-500" /> Address
                </label>
                <input
                  type="text"
                  name="address"
              ...
              <div className="space-y-1">
                <label className="text-sm font-medium text-gray-700 flex items-center">
                  <FiUser className="mr-1 text-green-500" /> Collector Email
                </label>
                <input
                  type="email"
                  name="collectorEmail"
              ...
              <div className="space-y-1">
                <label className="text-sm font-medium text-gray-700 flex items-center">
                  <FiMail className="mr-1 text-green-500" /> User Email
                </label>
                <input
                  type="email"
                  name="uemail"
          ...
          <div className="bg-gray-50 rounded-lg p-4 border border-gray-100">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-1">
                <label className="text-sm font-medium text-gray-700 flex items-center">
                  <FiCalendar className="mr-1 text-green-500" /> Scheduled Date
                </label>
                <input
                  type="date"
                  name="scheduledDate"
              ...
              <div className="space-y-1">
                <label className="text-sm font-medium text-gray-700 flex items-center">
                  <FiClock className="mr-1 text-green-500" /> Scheduled Time
                </label>
                <input
                  type="time"
                  name="scheduledTime"
                  ...
                  className="w-full border border-gray-200 rounded-lg px-3 py-2 text-gray-700 focus:ring-2 focus:ring-green-500 focus:outline-none"
                  required
                />
              </div>
            </div>
