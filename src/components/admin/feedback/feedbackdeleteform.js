...
const Feedbackdeleteform = ({ onClose, packageData, fetchData }) => {
  ...
  return (
    <div>
      <div className="fixed top-0 bottom-0 left-0 right-0 pt-80 pl-80 w-full h-full z-10 flex justify-center items-center bg-green-200 bg-opacity-30">
        <div className="text-black p-4 rounded w-full max-w-2xl h-full max-h-[90%] overflow-hidden">
          <div className="w-full max-w-md">
            ...
            >
              ...
              <div className="mb-4">
                <label
                  className="block text-navy-600 text-3xl font-bold mb-2"
                  htmlFor="firstName"
                >
                  Are You sure?
                </label>
            ...
            <p className="text-center text-red-800 text-xs">
              © 2024 <Link to={"/admin/default"}>ElephantBay</Link> All rights
              reserved
            </p>
          </div>
        </div>
