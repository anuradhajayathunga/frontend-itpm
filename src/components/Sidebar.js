      ...
      <div className="py-2 text-gray-700 ">
        <Link to="/" className="ml-7 -mb-4 ">
          {/* <img
              ...
              alt="Company logo"
            /> */}
          <div className="ml-10 text-[40px] font-bold text-dark">EcoBin</div>
        </Link>
        <ul className="mt-28">
          {[
          ...
          {/* <li className="relative px-6 py-3">
            ...
            {isPagesMenuOpen && (
              <ul className="p-2 mt-2 space-y-2 overflow-hidden text-sm font-medium text-gray-700 rounded-md shadow-inner bg-gray-50">
                {[
