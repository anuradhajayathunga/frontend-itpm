...
function FeedbackForm() {
  ...
  return (
    <div className="bg-greenGray-50 py-8 px-8 md:px-0">
      <h2 className="text-center text-lg font-bold text-green-500 mb-2">
        Feedback Form
      </h2>

      <form
        onSubmit={handleSubmit}
        className="max-w-lg mx-auto p-12 bg-white w-full mb-6 shadow-lg rounded"
      >
        <div className="mb-2">
        ...
        <div className="mb-2">
          ...
          <textarea
            ...
            onChange={handleChange}
            rows="3"
            className="form-textarea border-2 min-w-full"
          ></textarea>
        </div>
