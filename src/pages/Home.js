    ...
    <div>
      ...
      <div className="fixed bottom-10 right-10 z-50">
        <Link
          ...
          className="bg-c-green-300 text-white px-6 py-3 rounded-full shadow-lg hover:bg-c-green-400 transition-all duration-200 flex items-center justify-center"
        >
          Reviews
        </Link>
      </div>
